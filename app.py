...
# ================= DIABETES =================
    ...
    if st.button("Predict Diabetes"):
        data = np.array([[age, gender, bmi, bp, glucose, insulin,
                          skin, hba1c, chol, trig,
                          smoking, activity, family, medication]])
...
# ================= PARKINSON'S =================
     ...
     st.title("🧠 Parkinson’s Disease Prediction (Advanced)")

# ================= INPUTS =================

# Basic Info
     patient_id = st.number_input("Patient_ID")
     age = st.number_input("person_Age")
     gender = st.selectbox("Gender", ["male", "female"])
...
# Medical History
     family_history = st.selectbox("Family History (Parkinson’s)", ["Yes", "No"])
...
# Vitals
     ...
     chol_total = st.number_input("Total Cholesterol")
     chol_ldl = st.number_input("LDL")
     chol_hdl = st.number_input("HDL")
     chol_trig = st.number_input("Triglycerides")

# Clinical Scores
     updrs = st.number_input("UPDRS Score")
     moca = st.number_input("MoCA Score")
     functional = st.selectbox("Functional Assessment", ["Normal", "Mild", "Severe"])
...
# ================= ENCODING =================
     ...
     functional = {"Normal":0, "Mild":1, "Severe":2}[functional]
...
# ================= PREDICTION =================
     ...
     if st.button("Predict Parkinsons"):
        ...
        input_data = np.array([[
          patient_id, age, gender, ethnicity, education, bmi,
          smoking, alcohol, activity, diet, sleep_quality,
          family_history, tbi, hypertension, diabetes,
          depression, stroke,
          sys_bp, dia_bp,
